 (function() {
	...
	if (document.domain.toLowerCase().indexOf("bilibili.com") > 0){
		...
		$('h2').append('<span id="video-download"><a class="b-btn f" href="http://www.flvsp.com/?url='+encodeURIComponent(location.href)+'" title="下载视频" style="float:none;color:#fff;margin-left:8px; width:200px; height:100px;" target="_blank"><i class="icon icon-download"></i>详细信息及下载</a></span>')
		return
	}
